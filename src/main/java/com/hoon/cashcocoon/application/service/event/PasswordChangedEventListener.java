...
public class PasswordChangedEventListener {
    ...
    @Async
    @EventListener
    public void sendMail(PasswordChangedEvent passwordChangedEvent) throws InterruptedException, MessagingException {
        MimeMessage message = javaMailSender.createMimeMessage();

        message.setFrom(fromMail);
        message.setRecipients(MimeMessage.RecipientType.TO, passwordChangedEvent.getToAddress());
        ...
        body.append("<h1>" + "안녕하세요." + "</h1>")
                ...
                .append("<h1 style='color:blue'>").append(passwordChangedEvent.getNewPassword()).append("</h1>")
                .append("</div><br>")
                .append("<h3>" + "감사합니다." + "</h3>");
